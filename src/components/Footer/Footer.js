export const Footer = () => {
  return (
    <footer className="h-full flex justify-center py-5 items-center md:px-12 dark:border-gray-800">
      <a
        href="https://github.com/adilsonmandlate"
        rel="nofollow noopener noreferrer"
        className="text-gray-600 dark:text-gray-400 no-underline mr-10"
      >
        ...
        <svg
          ...
          className="transition-all inline md:hidden duration-500 hover:text-custom-dark-green dark:hover:text-custom-green"
        >
